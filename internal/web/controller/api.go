...
func (a *APIController) initRouter(g *gin.RouterGroup) {
	...
	api.Use(middleware.StellaActivationMiddleware())
	...
	// StellaGate is a compact single-VPS surface built on the same services.
	// It deliberately lives beside, rather than inside, the advanced APIs.
	NewStellaController(api.Group("/stella"))
